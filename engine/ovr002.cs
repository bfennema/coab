...
namespace engine
{
    class ovr002
    {
        ...
        static void credits()
        {
            ...
            {
                seg041.displayString("scenario created by:", 0, 10, 1, 2);
                seg041.displayString("tsr, inc.", 0, 0x0e, 2, 11);
                ...
                seg041.displayString("darla marasco", 0x0, 0x0B, 0x0E, 0x16);
                seg041.displayString("susan halbleib", 0x0, 0x0B, 0x0F, 0x16);
                seg041.displayString("testing:", 0x0, 0x0E, 0x12, 0x16);
