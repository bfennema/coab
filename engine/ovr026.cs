...
namespace engine
{
    class ovr026
    {
                        ...
                        case SkillType.Ranger:
                            if (skillLevel > 7)
                            {
                                ...
                                for (int TblIndex = 0; TblIndex <= (skillLevel - 9); TblIndex++)
                                {
                                    ...
                                    {
                                        player.spellCastCount[1][sp_lvl] += RangerSpellLevels[TblIndex, sp_lvl];
                                    }

                                    for (int sp_lvl = 3; sp_lvl < 5; sp_lvl++)
                                    {
                                        player.spellCastCount[2][sp_lvl - 3] += RangerSpellLevels[TblIndex, sp_lvl];
                                    }
                                }
        ...
        internal static void ReclacClassBonuses(Player player) // sub_6A3C6
        {
            ...
            if (player.fighter_lvl >= 13 ||
                player.paladin_lvl >= 13 ||
                player.ranger_lvl >= 15)
            {
                player.attacksCount = 4;
            }
            else if (player.fighter_lvl >= 7 ||
            ...
            if (DualClassExceedLastLevel(player) == true)
            {
                ...
                if (player.fighter_old_lvl > 12 ||
                    player.paladin_old_lvl > 12 ||
                    player.ranger_old_lvl > 14)
                {
                    player.attacksCount = 4;
                }
                else if (player.fighter_old_lvl > 6 ||
        ...
        static byte[, ,] SaveThrowValues = { // [8,13,5] class, level, save_type      
			{{20, 20, 20, 20, 20}, {10, 13, 14, 16, 15}, {10, 13, 14, 16, 15}, {10, 13, 14, 16, 15}, {9, 12, 13, 15, 14},  {9, 12, 13, 15, 14},  {9, 12, 13, 15, 14},  {7, 10, 11, 13, 12},  {7, 10, 11, 13, 12},  {7, 10, 11, 13, 12},  {6, 9, 10, 12, 11},   {6, 9, 10, 12, 11},   {6, 9, 10, 12, 11},   {5, 8, 9, 11, 10 }, {5, 8, 9, 11, 10 }, {5, 8, 9, 11, 10 }, {4, 7, 8, 10, 9 },  {4, 7, 8, 10, 9 }, {4, 7, 8, 10, 9 } },
			{{20, 20, 20, 20, 20}, {10, 13, 14, 16, 15}, {10, 13, 14, 16, 15}, {10, 13, 14, 16, 15}, {9, 12, 13, 15, 14},  {9, 12, 13, 15, 14},  {9, 12, 13, 15, 14},  {7, 10, 11, 13, 12},  {7, 10, 11, 13, 12},  {7, 10, 11, 13, 12},  {6, 9, 10, 12, 11},   {6, 9, 10, 12, 11},   {6, 9, 10, 12, 11},   {5, 8, 9, 11, 10 }, {5, 8, 9, 11, 10 }, {5, 8, 9, 11, 10 }, {4, 7, 8, 10, 9 },  {4, 7, 8, 10, 9 }, {4, 7, 8, 10, 9 } },
			{{20, 20, 20, 20, 20}, {14, 15, 16, 17, 17}, {14, 15, 16, 17, 17}, {13, 14, 15, 16, 16}, {13, 14, 15, 16, 16}, {11, 12, 13, 13, 14}, {11, 12, 13,13, 14},  {10, 11, 12, 12, 13}, {10, 11, 12, 12, 13}, {8, 9, 10, 9, 11},    {8, 9, 10, 9, 11},    {7, 8, 9, 8, 10},     {7, 8, 9, 8, 10},     {5, 6, 7, 5, 8 },   {5, 6, 7, 5, 8 },   {4, 5, 6, 4, 7 },   {4, 5, 6, 4, 7 },   {3, 4, 5, 4, 6 },  {3, 4, 5, 4, 6 } },
			{{20, 20, 20, 20, 20}, {12, 13, 14, 15, 15}, {12, 13, 14, 15, 15}, {11, 12, 13, 14, 14}, {11, 12, 13, 14, 14}, {9, 9, 11, 11, 12},   {9, 9, 11, 11, 12},   {8, 9, 10, 10, 11},   {8, 9, 10, 10, 11},   {6, 7, 8, 7, 9},      {6, 7, 8, 7, 9},      {5, 6, 7, 6, 8},      {5, 6, 7, 6, 8},      {3, 4, 5, 3, 6 },   {3, 4, 5, 3, 6 },   {2, 3, 4, 2, 5 },   {2, 3, 4, 2, 5 },   {1, 2, 3, 2, 4 },  {1, 2, 3, 2, 4 } },
			{{20, 20, 20, 20, 20}, {14, 15, 16, 17, 17}, {14, 15, 16, 17, 17}, {13, 14, 15, 16, 16}, {13, 14, 15, 16, 16}, {11, 12, 13, 13, 14}, {11, 12, 13, 13, 14}, {10, 11, 12, 12, 13}, {10, 11, 12, 12, 13}, {8, 9, 10, 9, 11},    {8, 9, 10, 9, 11},    {7, 8, 9, 8, 10},     {7, 8, 9, 8, 10},     {5, 6, 7, 5, 8 },   {5, 6, 7, 5, 8 },   {4, 5, 6, 4, 7 },   {4, 5, 6, 4, 7 },   {3, 4, 5, 4, 6 },  {3, 4, 5, 4, 6 } },
            {{20, 20, 20, 20, 20}, {14, 13, 11, 15, 12}, {14, 13, 11, 15, 12}, {14, 13, 11, 15, 12}, {14, 13, 11, 15, 12}, {14, 13, 11, 15, 12}, {13, 11, 9, 13, 10},  {13, 11, 9, 13, 10},  {13, 11, 9, 13, 10},  {13, 11, 9, 13, 10},  {13, 11, 9, 13, 10},  {11, 9, 7, 11, 8},    {11, 9, 7, 11, 8},    {11, 9, 7, 11, 8 }, {11, 9, 7, 11, 8 }, {11, 9, 7, 11, 8 }, {10, 7, 5, 9, 6 },  {10, 7, 5, 9, 6 }, {10, 7, 5, 9, 6 } },
			{{20, 20, 20, 20, 20}, {13, 12, 14, 16, 15}, {13, 12, 14, 16, 15}, {13, 12, 14, 16, 15}, {13, 12, 14, 16, 15}, {12, 11, 12, 15, 13}, {12, 11, 12, 15, 13}, {12, 11, 12, 15, 13}, {12, 11, 12, 15, 13}, {11, 10, 10, 14, 11}, {11, 10, 10, 14, 11}, {11, 10, 10, 14, 11}, {11, 10, 10, 14, 11}, {10, 9, 8, 13, 9 }, {10, 9, 8, 13, 9 }, {10, 9, 8, 13, 9 }, {10, 9, 8, 13, 9 }, {9, 8, 6, 12, 7 }, {9, 8, 6, 12, 7 } },
			{{20, 20, 20, 20, 20}, {13, 12, 14, 16, 15}, {13, 12, 14, 16, 15}, {13, 12, 14, 16, 15}, {13, 12, 14, 16, 15}, {12, 11, 12, 15, 13}, {12, 11, 12, 15, 13}, {12, 11, 12, 15, 13}, {12, 11, 12, 15, 13}, {11, 10, 10, 14, 11}, {11, 10, 10, 14, 11}, {11, 10, 10, 14, 11}, {11, 10, 10, 14, 11}, {10, 9, 8, 13, 9 }, {10, 9, 8, 13, 9 }, {10, 9, 8, 13, 9 }, {10, 9, 8, 13, 9 }, {9, 8, 6, 12, 7 }, {9, 8, 6, 12, 7 } },
        };
