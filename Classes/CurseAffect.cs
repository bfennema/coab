namespace Classes
{
    ...
    public class CurseAffect
    {
        ...
        static void InitMapping()
        {
            ...
            mapping.Add(Affects.none, Classes.Affects.none);
            mapping.Add(Affects.bless, Classes.Affects.bless);
            mapping.Add(Affects.cursed, Classes.Affects.cursed);
            mapping.Add(Affects.sticks_to_snakes, Classes.Affects.sticks_to_snakes);
            mapping.Add(Affects.dispel_evil, Classes.Affects.dispel_evil);
            ...
            mapping.Add(Affects.poison_damage, Classes.Affects.poison_damage);
            ...
            mapping.Add(Affects.fumbling, Classes.Affects.fumbling);
            ...
            mapping.Add(Affects.confuse, Classes.Affects.confuse);
            ...
            mapping.Add(Affects.dwarf_and_gnome_vs_giants, Classes.Affects.giant_vs_dwarf_gnome);
            ...
            mapping.Add(Affects.hot_fire_shield, Classes.Affects.hot_fire_shield);
            ...
            mapping.Add(Affects.cold_fire_shield, Classes.Affects.cold_fire_shield);
            ...
            mapping.Add(Affects.engulf, Classes.Affects.engulf);
            ...
            mapping.Add(Affects.resist_fire_and_cold, Classes.Affects.resist_fire_and_cold);
            mapping.Add(Affects.petrifying_gaze, Classes.Affects.petrifying_gaze);
            mapping.Add(Affects.shambling_absorb_lightning, Classes.Affects.shambling_absorb_lightning);
            mapping.Add(Affects.resist_piercing, Classes.Affects.resist_piercing);
            mapping.Add(Affects.spit_acid, Classes.Affects.spit_acid);
            mapping.Add(Affects.beholder_eyestalk, Classes.Affects.beholder_eyestalk);
            ...
            mapping.Add(Affects.affect_in_cloud_kill, Classes.Affects.affect_in_cloud_kill);
            ...
            mapping.Add(Affects.half_elec, Classes.Affects.half_elec);
            ...
            mapping.Add(Affects.dracolich_paralysis, Classes.Affects.dracolich_paralysis);
            mapping.Add(Affects.dracolich_cold_damage, Classes.Affects.dracolich_cold_damage);
            ...
            mapping.Add(Affects.cast_throw_lightening, Classes.Affects.cast_throw_lightening);
            mapping.Add(Affects.dracolich_protection, Classes.Affects.dracolich_protection);
            mapping.Add(Affects.ranger_vs_giant, Classes.Affects.ranger_vs_giant);
            mapping.Add(Affects.protect_elec, Classes.Affects.protect_elec);
            mapping.Add(Affects.entangle, Classes.Affects.entangle);
            mapping.Add(Affects.confuse_berserk, Classes.Affects.confuse_berserk);
            mapping.Add(Affects.add_invisibility, Classes.Affects.add_invisibility);
            mapping.Add(Affects.affect_8b, Classes.Affects.affect_8b);
            mapping.Add(Affects.paladinDailyHealCast, Classes.Affects.paladinDailyHealCast);
            mapping.Add(Affects.paladinDailyCureRefresh, Classes.Affects.paladinDailyCureRefresh);
            mapping.Add(Affects.fear, Classes.Affects.fear);
            mapping.Add(Affects.fire_shield_damage, Classes.Affects.fire_shield_damage);
            mapping.Add(Affects.owlbear_hug_round_attack, Classes.Affects.owlbear_hug_round_attack);
        ...
        private CurseAffect(Affects _type, ushort _minutes, byte _affect_data, bool _call_spell_jump_list)
        {
            type = _type;
            minutes = _minutes;
