...
namespace Classes
{
    ...
    public class gbl
    {
        ...
        public static SpellEntry[] spellCastingTable = { /* seg600:37DC asc_19AEC */
            ...
            new SpellEntry(Spells.resist_cold,                  SpellClass.Cleric,    1, 0, 0, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Normal,  SaveVerseType.Spell, Affects.spell_resist_cold, SpellWhen.Both, 10, 0, 0, 0),
            ...
            new SpellEntry(Spells.resist_fire,                  SpellClass.Cleric,    2, 0, 0, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.spell_resist_fire, SpellWhen.Both, 5, 1, 0, 0),
            ...
            new SpellEntry(Spells.cure_disease_CL,              SpellClass.Cleric,    3, 0, 0, 0, 0, 0, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Camp, 100, 0, 0, 0),
            new SpellEntry(Spells.cause_disease_CL,             SpellClass.Cleric,    3, -1, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.cause_disease_1, SpellWhen.Combat, 100, 4, 1, 0),
            ...
            new SpellEntry(Spells.cure_disease_DR,              SpellClass.Druid,     3, 0, 0, 0, 0, 0, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Camp, 10, 0, 0, 0),
            new SpellEntry(Spells.cause_disease_DR,             SpellClass.Druid,     3, -1, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.cause_disease_1, SpellWhen.Combat, 10, 4, 1, 0),
            ...
            new SpellEntry(Spells.protection_from_fire,         SpellClass.Druid,     3, 0, 0, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.protection_from_fire, SpellWhen.Both, 5, 1, 0, 0),
            ...
            new SpellEntry(Spells.hold_plant,                   SpellClass.Druid,     4, 8, 0, 0, 2, 7, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.paralyze, SpellWhen.Combat, 5, 7, 1, 0),
            new SpellEntry(Spells.protection_from_lightning,    SpellClass.Druid,     4, 0, 0, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.protection_from_lightning, SpellWhen.Both, 6, 1, 0, 0),
