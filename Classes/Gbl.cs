...
namespace Classes
{
    ...
    public class gbl
    {
        ...
        public static SpellEntry[] spellCastingTable = { /* seg600:37DC asc_19AEC */
            ...
            new SpellEntry((byte)Spells.cause_light_wounds_CL,        SpellClass.Cleric,    1, -1, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Normal,  SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 5, 2, 1, 0),
            new SpellEntry((byte)Spells.detect_magic_CL,              SpellClass.Cleric,    1, 3, 0, 10, 0, 0, SpellTargets.Self, DamageOnSave.Normal,  SaveVerseType.Spell, Affects.detect_magic, SpellWhen.Both, 1, 0, 0, 0),
            new SpellEntry((byte)Spells.protect_from_evil_CL,         SpellClass.Cleric,    1, 0, 0, 0, 3, 4, SpellTargets.PartyMember, DamageOnSave.Normal,   SaveVerseType.Spell, Affects.protection_from_evil, SpellWhen.Both, 4, 1, 0, 0),
            new SpellEntry((byte)Spells.protect_from_good_CL,         SpellClass.Cleric,    1, 0, 0, 0, 3, 4, SpellTargets.PartyMember, DamageOnSave.Normal,   SaveVerseType.Spell, Affects.protection_from_good, SpellWhen.Both, 4, 1, 0, 0),
            new SpellEntry((byte)Spells.resist_cold,                  SpellClass.Cleric,    1, 0, 0, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Normal,  SaveVerseType.Spell, Affects.resist_cold, SpellWhen.Both, 10, 0, 0, 0),
            new SpellEntry((byte)Spells.burning_hands,                SpellClass.MagicUser, 1, 0, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 1, 2, 1, 0),
            new SpellEntry((byte)Spells.charm_person,                 SpellClass.MagicUser, 1, 12, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.charm_person, SpellWhen.Combat, 1, 4, 1, 0),
            new SpellEntry((byte)Spells.detect_magic_MU,              SpellClass.MagicUser, 1, 0, 0, 0, 2, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.detect_magic, SpellWhen.Both, 1, 0, 0, 0),
            new SpellEntry((byte)Spells.enlarge,                      SpellClass.MagicUser, 1, 0, 2, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.enlarge, SpellWhen.Both, 1, 0, 0, 0),
            new SpellEntry((byte)Spells.reduce,                       SpellClass.MagicUser, 1, 0, 2, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Zero, SaveVerseType.Spell, Affects.reduce, SpellWhen.Both, 1, 0, 1, 0),
            new SpellEntry((byte)Spells.friends,                      SpellClass.MagicUser, 1, 0, 0, 0, 1, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.friends, SpellWhen.Camp, 1, 0, 0, 0),
            new SpellEntry((byte)Spells.magic_missile,                SpellClass.MagicUser, 1, 6, 4, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 1, 4, 1, 0),
            new SpellEntry((byte)Spells.protect_from_evil_MU,         SpellClass.MagicUser, 1, 0, 0, 0, 2, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.protection_from_evil, SpellWhen.Both, 1, 1, 0, 0),
            new SpellEntry((byte)Spells.protect_from_good_MU,         SpellClass.MagicUser, 1, 0, 0, 0, 2, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.protection_from_good, SpellWhen.Both, 1, 1, 0, 0),
            new SpellEntry((byte)Spells.read_magic,                   SpellClass.MagicUser, 1, 0, 0, 0, 2, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.read_magic, SpellWhen.Camp, 10, 0, 0, 0),
            new SpellEntry((byte)Spells.shield,                       SpellClass.MagicUser, 1, 0, 0, 0, 5, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.shield, SpellWhen.Both, 1, 2, 0, 0),
            new SpellEntry((byte)Spells.shocking_grasp,               SpellClass.MagicUser, 1, -1, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 1, 2, 1, 0),
            new SpellEntry((byte)Spells.sleep,                        SpellClass.MagicUser, 1, 3, 4, 0, 5, 9, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.sleep, SpellWhen.Combat, 1, 2, 1, 1),
            new SpellEntry((byte)Spells.find_traps,                   SpellClass.Cleric,    2, 0, 0, 30, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.find_traps, SpellWhen.Camp, 5, 0, 0, 0),
            new SpellEntry((byte)Spells.hold_person_CL,               SpellClass.Cleric,    2, 6, 0, 4, 1, 6, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.paralyze, SpellWhen.Combat, 5, 6, 1, 0),
            new SpellEntry((byte)Spells.resist_fire,                  SpellClass.Cleric,    2, 0, 0, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.resist_fire, SpellWhen.Both, 5, 1, 0, 0),
            new SpellEntry((byte)Spells.silence_15_radius,            SpellClass.Cleric,    2, 12, 0, 0, 2, 31, SpellTargets.Combat, DamageOnSave.Unknown_3, SaveVerseType.Spell, Affects.silence_15_radius, SpellWhen.Combat, 5, 4, 1, 1), /* 396C - */
			new SpellEntry((byte)Spells.slow_poison,                  SpellClass.Cleric,    2, 0, 0, 0, 60, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.slow_poison, SpellWhen.Both, 1, 0, 0, 0),
            new SpellEntry((byte)Spells.snake_charm,                  SpellClass.Cleric,    2, 3, 0, 0, 0, 240, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.snake_charm, SpellWhen.Combat, 5, 0, 1, 0),
            new SpellEntry((byte)Spells.spiritual_hammer,             SpellClass.Cleric,    2, 3, 0, 0, 1, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.spiritual_hammer, SpellWhen.Both, 5, 1, 0, 0),
            new SpellEntry((byte)Spells.detect_invisibility,          SpellClass.MagicUser, 2, 0, 4, 0, 5, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.detect_invisibility, SpellWhen.Both, 2, 1, 0, 0),
            new SpellEntry((byte)Spells.invisibility,                 SpellClass.MagicUser, 2, 0, 0, 0, 0, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.invisibility, SpellWhen.Both, 2, 2, 0, 0),
            new SpellEntry((byte)Spells.knock,                        SpellClass.MagicUser, 2, 0, 0, 0, 0, 0, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Camp, 1, 0, 0, 0),
            new SpellEntry((byte)Spells.mirror_image,                 SpellClass.MagicUser, 2, 0, 0, 0, 2, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.mirror_image, SpellWhen.Both, 2, 3, 0, 0),
            new SpellEntry((byte)Spells.ray_of_enfeeblement,          SpellClass.MagicUser, 2, 1, 1, 0, 1, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.ray_of_enfeeblement, SpellWhen.Combat, 2, 2, 1, 0),
            new SpellEntry((byte)Spells.stinking_cloud,               SpellClass.MagicUser, 2, 3, 0, 0, 1, 9, SpellTargets.Combat, DamageOnSave.Unknown_3, SaveVerseType.Poison, Affects.stinking_cloud, SpellWhen.Combat, 2, 5, 1, 1),
            new SpellEntry((byte)Spells.strength,                     SpellClass.MagicUser, 2, 0, 0, 0, 60, 0, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.strength, SpellWhen.Camp, 10, 0, 0, 0),
            new SpellEntry((byte)Spells.animate_dead,                 SpellClass.Monster,   7, 4, 0, 0, 0, 8, SpellTargets.WholeParty, DamageOnSave.Zero, SaveVerseType.Spell, Affects.none, SpellWhen.Both, 0, 2, 0, 0),
            new SpellEntry((byte)Spells.cure_blindness,               SpellClass.Cleric,    3, 0, 0, 0, 0, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Both, 10, 0, 0, 0),
            new SpellEntry((byte)Spells.cause_blindness,              SpellClass.Cleric,    3, -1, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.blinded, SpellWhen.Combat, 10, 3, 1, 0),
            new SpellEntry((byte)Spells.cure_disease,                 SpellClass.Cleric,    3, 0, 0, 0, 0, 0, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Camp, 100, 0, 0, 0),
            new SpellEntry((byte)Spells.cause_disease,                SpellClass.Cleric,    3, -1, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.cause_disease_1, SpellWhen.Combat, 100, 4, 1, 0),
            new SpellEntry((byte)Spells.dispel_magic_CL,              SpellClass.Cleric,    3, 6, 0, 0, 0, 9, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Both, 4, 3, 1, 1),
            new SpellEntry((byte)Spells.prayer,                       SpellClass.Cleric,    3, 0, 0, 0, 1, 0, SpellTargets.WholeParty, DamageOnSave.Normal, SaveVerseType.Spell, Affects.prayer, SpellWhen.Both, 6, 5, 0, 0),
            new SpellEntry((byte)Spells.remove_curse_CL,              SpellClass.Cleric,    3, 0, 0, 0, 0, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Both, 6, 0, 0, 0),
            new SpellEntry((byte)Spells.bestow_curse_CL,              SpellClass.Cleric,    3, -1, 0, 0, 10, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.bestow_curse, SpellWhen.Combat, 6, 5, 1, 0),
            new SpellEntry((byte)Spells.blink,                        SpellClass.MagicUser, 3, 0, 0, 0, 1, 0, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.blink, SpellWhen.Combat, 1, 2, 0, 0),
            new SpellEntry((byte)Spells.dispel_magic_MU,              SpellClass.MagicUser, 3, 12, 0, 0, 1, 9, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Both, 3, 2, 1, 1),
            new SpellEntry((byte)Spells.fireball,                     SpellClass.MagicUser, 3, 10, 1, 0, 0, 11, SpellTargets.Combat, DamageOnSave.Half, SaveVerseType.Spell, Affects.none,SpellWhen.Combat, 3, 7, 1, 3),
            new SpellEntry((byte)Spells.haste,                        SpellClass.MagicUser, 3, 6, 0, 3, 1, 10, SpellTargets.WholeParty, DamageOnSave.Normal, SaveVerseType.Spell, Affects.haste, SpellWhen.Both, 3, 3, 0, 0),
            new SpellEntry((byte)Spells.hold_person_MU,               SpellClass.MagicUser, 3, 12, 0, 0, 2, 7, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.paralyze, SpellWhen.Combat, 3, 6, 1, 0),
            new SpellEntry((byte)Spells.invisibility_10_radius,       SpellClass.MagicUser, 3, 0, 0, 0, 0, 9, SpellTargets.WholeParty, DamageOnSave.Normal, SaveVerseType.Spell, Affects.invisibility, SpellWhen.Both, 3, 1, 0, 0),
            new SpellEntry((byte)Spells.lightning_bolt,               SpellClass.MagicUser, 3, 4, 1, 0, 0, 8, SpellTargets.Combat, DamageOnSave.Half, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 3, 6, 1, 0),
            new SpellEntry((byte)Spells.protect_from_evil_10_rad,     SpellClass.MagicUser, 3, 0, 0, 0, 2, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.prot_from_evil_10_radius, SpellWhen.Both, 3, 1, 0, 0),
            new SpellEntry((byte)Spells.protect_from_good_10_rad,     SpellClass.MagicUser, 3, 0, 0, 0, 2, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.prot_from_good_10_radius, SpellWhen.Both, 3, 2, 0, 0),
            new SpellEntry((byte)Spells.protect_from_normal_missiles, SpellClass.MagicUser, 3, 0, 0, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.prot_from_normal_missiles, SpellWhen.Both, 3, 3, 0, 0),
            new SpellEntry((byte)Spells.slow,                         SpellClass.MagicUser, 3, 9, 1, 3, 1, 10, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.slow, SpellWhen.Combat, 3, 4, 1, 0),
            new SpellEntry((byte)Spells.restoration,                  SpellClass.Cleric,    7, 0, 0, 0, 0, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Both, 6, 0, 0, 0),
            new SpellEntry((byte)Spells.spell_39,                     SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.haste, SpellWhen.Both, 0, 3, 0, 0),
            new SpellEntry((byte)Spells.cure_serious_wounds_CL,       SpellClass.Cleric,    4, 0, 0, 0, 0, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Both, 7, 1, 0, 0),
            new SpellEntry((byte)Spells.spell_3b,                     SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.strength, SpellWhen.Both, 0, 1, 0, 0),
            new SpellEntry((byte)Spells.spell_3c,                     SpellClass.Monster,   6, 4, 4, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Half, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 0, 7, 1, 0),
            new SpellEntry((byte)Spells.spell_3d,                     SpellClass.Monster,   6, 6, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Poison, Affects.paralyze, SpellWhen.Combat, 0, 7, 1, 0),
            new SpellEntry((byte)Spells.spell_3e,                     SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.haste, SpellWhen.Both, 0, 1, 0, 0),
            new SpellEntry((byte)Spells.spell_3f,                     SpellClass.Monster,   6, 0, 0, 0, 0, 7, SpellTargets.WholeParty, DamageOnSave.Normal, SaveVerseType.Spell, Affects.invisible, SpellWhen.Both, 0, 2, 0, 0),
            new SpellEntry((byte)Spells.spell_40,                     SpellClass.Monster,   6, 7, 0, 0, 0, 11, SpellTargets.Combat, DamageOnSave.Half, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 0, 7, 1, 3),
            new SpellEntry((byte)Spells.spell_41,                     SpellClass.Monster,   6, 12, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 0, 6, 1, 0),
            new SpellEntry((byte)Spells.cause_serious_wounds_CL,      SpellClass.Cleric,    4, 0, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 7, 5, 1, 0),
            new SpellEntry((byte)Spells.neutralize_poison_CL,         SpellClass.Cleric,    4, 0, 0, 0, 0, 0, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Camp, 7, 0, 0, 0),
            new SpellEntry((byte)Spells.poison,                       SpellClass.Cleric,    4, 0, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Poison, Affects.none, SpellWhen.Combat, 7, 6, 1, 0),
            new SpellEntry((byte)Spells.protect_evil_10_rad,          SpellClass.Cleric,    4, 3, 0, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.prot_from_evil_10_radius, SpellWhen.Both, 7, 2, 0, 0),
            new SpellEntry((byte)Spells.sticks_to_snakes_CL,          SpellClass.Cleric,    4, 3, 0, 0, 2, 4, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.sticks_to_snakes, SpellWhen.Combat, 7, 4, 1, 0),
            new SpellEntry((byte)Spells.cure_critical_wounds,         SpellClass.Cleric,    5, 0, 0, 0, 0, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Both, 8, 2, 0, 0),
            new SpellEntry((byte)Spells.cause_critical_wounds,        SpellClass.Cleric,    5, -1, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 8, 6, 1, 0),
            new SpellEntry((byte)Spells.dispel_evil,                  SpellClass.Cleric,    5, 0, 0, 0, 1, 0, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.sp_dispel_evil, SpellWhen.Combat, 8, 3, 0, 0),
            new SpellEntry((byte)Spells.flame_strike,                 SpellClass.Cleric,    5, 6, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Half, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 8, 6, 1, 0),
            new SpellEntry((byte)Spells.raise_dead,                   SpellClass.Cleric,    5, 0, 0, 0, 0, 0, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Camp, 10, 1, 0, 0),
            new SpellEntry((byte)Spells.slay_living,                  SpellClass.Cleric,    5, 3, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 10, 7, 1, 0),
            new SpellEntry((byte)Spells.detect_magic_DR,              SpellClass.Druid,     1, 3, 0, 12, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.detect_magic, SpellWhen.Both, 3, 1, 0, 0),
            new SpellEntry((byte)Spells.entangle,                     SpellClass.Druid,     1, 8, 0, 10, 0, 11, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.entangle, SpellWhen.Combat, 3, 3, 1, 0),
            new SpellEntry((byte)Spells.faerie_fire,                  SpellClass.Druid,     1, 8, 0, 0, 4, 5, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.faerie_fire, SpellWhen.Combat, 3, 4, 1, 0),
            new SpellEntry((byte)Spells.invisibility_to_animals,      SpellClass.Druid,     1, -1, 0, 10, 1, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.invisible_to_animals, SpellWhen.Both, 4, 1, 1, 0),
            new SpellEntry((byte)Spells.charm_monsters,               SpellClass.MagicUser, 4, 6, 0, 0, 0, 5, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.charm_person, SpellWhen.Combat, 4, 6, 1, 0),
            new SpellEntry((byte)Spells.hold_monsters,                SpellClass.MagicUser, 4, 12, 0, 2, 1, 11, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.confuse, SpellWhen.Combat, 4, 7, 1, 0),
            new SpellEntry((byte)Spells.dimension_door,               SpellClass.MagicUser, 4, 0, 3, 0, 0, 8, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 1, 0, 1, 0),
            new SpellEntry((byte)Spells.fear,                         SpellClass.MagicUser, 4, 6, 0, 0, 1, 8, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.fear, SpellWhen.Combat, 4, 6, 1, 0),
            new SpellEntry((byte)Spells.fire_shield,                  SpellClass.MagicUser, 4, 0, 0, 2, 1, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Both, 4, 8, 0, 0),
            new SpellEntry((byte)Spells.fumble,                       SpellClass.MagicUser, 4, 0, 1, 0, 1, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.fumbling, SpellWhen.Combat, 4, 4, 1, 0),
            new SpellEntry((byte)Spells.ice_storm,                    SpellClass.MagicUser, 4, 0, 1, 0, 0, 10, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 4, 7, 1, 0),
            new SpellEntry((byte)Spells.minor_globe_of_invuln,        SpellClass.MagicUser, 4, 0, 1, 0, 1, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.minor_globe_of_invulnerability, SpellWhen.Both, 4, 5, 0, 0),
            new SpellEntry((byte)Spells.remove_curse_MU,              SpellClass.MagicUser, 4, 0, 0, 0, 0, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Both, 4, 0, 0, 0),
            new SpellEntry((byte)Spells.spell_5a,                     SpellClass.Monster,   5, 1, 0, 0, 0, 240, SpellTargets.WholeParty, DamageOnSave.Normal, SaveVerseType.Spell, Affects.animate_dead, SpellWhen.Both, 5, 0, 0, 0),
            new SpellEntry((byte)Spells.cloud_kill,                   SpellClass.MagicUser, 5, 2, 0, 0, 1, 9, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Both, 5, 5, 1, 0),
            new SpellEntry((byte)Spells.cone_of_cold,                 SpellClass.MagicUser, 5, 6, 0, 0, 0, 8, SpellTargets.Combat, DamageOnSave.Half, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 5, 6, 1, 0),
            new SpellEntry((byte)Spells.feeblemind,                   SpellClass.MagicUser, 5, 16, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.feeblemind, SpellWhen.Combat, 5, 6, 1, 0),
            new SpellEntry((byte)Spells.hold_monsters,                SpellClass.MagicUser, 5, 0, 1, 0, 1, 7, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.paralyze, SpellWhen.Combat, 5, 7, 1, 0),
            new SpellEntry((byte)Spells.spell_5f,                     SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.prot_drag_breath, SpellWhen.Both, 10, 1, 0, 0),
            new SpellEntry((byte)Spells.spell_60,                     SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.resist_paralyze, SpellWhen.Both, 10, 1, 0, 0),
            new SpellEntry((byte)Spells.spell_61,                     SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.invisibility, SpellWhen.Both, 0, 1, 0, 0),
            new SpellEntry((byte)Spells.spell_62,                     SpellClass.Monster,   6, 3, 0, 0, 0, 11, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 0, 1, 1, 0),
