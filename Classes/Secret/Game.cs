...
namespace Classes.Secret
{
    public class Game : Classes.Game
    {
        ...
        public override async Task<bool> Load()
        {
            ...
            await DaxCache.PreloadDax("PIC", 4);
            await DaxCache.PreloadDax("PIC", 5);
        ...
        public override Logging.Game Name { get => Logging.Game.SecretOfTheSilverBlades; }
        public override ImportSource ImportFrom { get => Classes.ImportSource.Secret; }
        public override string[]? ImportSources { get => ["Secret", "Curse"]; }
        public override int InitialExp { get => 200000; }
        public override MoneySet? InitialMoney { get => new MoneySet(); }
        public override string DemoString
        {
            get
            {
                ...
                gbl.displayString("      Secret of the Silver Blades      ", 10, 0, 22, 0);
                gbl.displayString("   Version 1.30           May 18,1990  ", 10, 0, 23, 0);
                return "              ";
            }
        }
        ...
        public override byte DemoEclBlockId { get => 3; }
        public override byte InitialGameArea { get => 2; }
        public override byte Tile8x8D201 { get => 5; }
        ...
        public override byte InitialEclBlockId { get => 17; }
