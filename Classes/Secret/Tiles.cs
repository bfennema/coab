...
namespace Classes.Secret
{
    internal class Tiles
    {
        readonly static Tile[] background =
        {
            ...
            new(1, 1, 0, 26 ), // [28] CLOUDKILL
            new(1, 1, 0, 27 ), // [29] EMPTY
            new(1, 1, 0, 28 ), // [30] STINKING CLOUD
            new(1, 1, 0, 29 ), // [31] DEAD BODY
            // WILDCOM [0-33]
            new(   1, 2,  0 ), // [32] TREE TOP 0
            new(   1, 2,  1 ), // [33] TREE TOP 1
            new(   1, 2,  2 ), // [34] TREE TOP 2
            new(   1, 2,  3 ), // [35] TREE TOP 3
            new(   1, 2,  4 ), // [36] TREE TOP 4
            new(1, 1, 0,  5 ), // [37] TREE BOTTOM 0
            new(1, 1, 0,  6 ), // [38] TREE BOTTOM 1
            new(1, 1, 0,  7 ), // [39] TREE BOTTOM 2
            new(1, 1, 0,  8 ), // [40] TREE BOTTOM 3
            ...
            new(4, 0, 0, 31 ), // [63] RIVER EAST BANK 1
            new(1, 1, 0, 32 ), // [64] RIVER EAST BANK
            new(1, 1, 0, 33 ), // [65] RIVER WEST BANK
        };
        public static Tile[] Background { get => background; }
        public static void SetupBackground()
        {
            gbl.Load24x24Set(30, 0, 1, "DungCom");
