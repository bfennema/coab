...
namespace Classes
{
    ...
    public enum ItemType
    {
        ...
        CloakOfProt = 67,
        Boots = 68,
        Ring = 69, // Invis, Fire Resistence (POR)
        Necklace = 70, // Gems, Jewel, Necklace, Dust, Ioun Stone
        Potion = 71, // Silver Mirror
        Tapestry = 72, // POR, Statuette, Chain of Bone, Rug, Brazier, Saddle
        Arrow = 73,
        HolySymbol = 74, // POR
        Key = 75, // POR
        CursedNecklace = 76, // POR
        Bracers = 77,
        WandA = 78,
        WandB = 79,
        Type_80 = 80,
        Type_81 = 81,
        EfreetiBottle = 82, // POR
        Type_83 = 83,
        PotionOfGiantStr = 84,
        HolyWater = 85,
        FlaskOfOil = 86,
