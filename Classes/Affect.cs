...
namespace Classes
{
    public enum Affects
    {
        ...
        affect_98 = 0x98,
        affect_99 = 0x99,
        harpy_charm_attack = 0x9a,
        affect_9b = 0x9b,
        mummy_disease_rot = 0x9c,
        mummy_fear = 0x9d,
        affect_9e = 0x9e,
        ...
        energy_drain_1 = 0xa3,
        energy_drain_2 = 0xa4,
        studying_manual_bodily_health = 0xa5,
        training_manual_bodily_health = 0xa6,
        periapt_health = 0xa7,
        stone_good_luck = 0xa8,
        barkskin = 0xa9,
        protection_from_fire = 0xaa,
        resist_lightning = 0xab,
        protection_from_lightning = 0xac,
    }
