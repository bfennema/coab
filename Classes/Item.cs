...
namespace Classes
{
    ...
    public class Item
    {
        ...
        public Item(Affects _affect_3, Affects _affect_2, Affects _affect_1, short __value, byte _count,
            ...
            Names _namenum2, Names _namenum1, ItemType _type, bool AddToLibrary)
        {
            name = string.Empty;
            type = _type;
            namenum = new Names[3];
                ...
                if (((display_flags >> (var_1 - 1)) & 1) > 0)
                {
                        ...
                        pural_added == true)
                    {
                        name += " ";
                            ...
                            (namenum[2] != Names.Blessed && (type == ItemType.Arrow || type == ItemType.Quarrel || type == ItemType.Dart) && namenum[2] != Names.Silver))
                    {
                        name += "s ";
                        pural_added = true;
                    }
