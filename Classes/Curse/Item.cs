namespace Classes.Curse
{
    public class Item
    {
        ...
        private static BiLookup<Type, Classes.Item.Type> InitTypeMap()
        {
            ...
            map.Add(Type.Type_48, Classes.Item.Type.Type_48);
            map.Add(Type.Type_49, Classes.Item.Type.Type_49);
            ...
            map.Add(Type.Hat, Classes.Item.Type.Hat);
            map.Add(Type.Girdle, Classes.Item.Type.Girdle);
            map.Add(Type.Robe, Classes.Item.Type.Robe);
            ...
            map.Add(Type.Type_72, Classes.Item.Type.Commodities);
            map.Add(Type.Arrow, Classes.Item.Type.Arrow);
            map.Add(Type.Type_74, Classes.Item.Type.HolySymbol);
            map.Add(Type.Type_75, Classes.Item.Type.Key);
            map.Add(Type.Type_76, Classes.Item.Type.CursedNecklace);
            ...
            map.Add(Type.Type_80, Classes.Item.Type.Type_80);
            map.Add(Type.Type_81, Classes.Item.Type.Type_81);
            map.Add(Type.Type_82, Classes.Item.Type.EfreetiBottle);
            map.Add(Type.Type_83, Classes.Item.Type.Type_83);
            map.Add(Type.PotionOfGiantStr, Classes.Item.Type.PotionOfGiantStr);
            map.Add(Type.Type_85, Classes.Item.Type.HolyWater);
            map.Add(Type.FlaskOfOil, Classes.Item.Type.FlaskOfOil);
            map.Add(Type.Type_87, Classes.Item.Type.HillGiantBoulder);
            map.Add(Type.Type_88, Classes.Item.Type.CloudGiantBoulder);
            map.Add(Type.Type_89, Classes.Item.Type.FireGiantBoulder);
            map.Add(Type.Type_90, Classes.Item.Type.RingOfFeatherFall);
            map.Add(Type.Type_91, Classes.Item.Type.Pass);
            map.Add(Type.CloakOfDisplacement, Classes.Item.Type.CloakOfDisplacement);
            map.Add(Type.RingOfProt, Classes.Item.Type.RingOfProt);
            map.Add(Type.DrowMace, Classes.Item.Type.DrowMace);
            map.Add(Type.ElvenChain, Classes.Item.Type.ElvenChain);
            map.Add(Type.DrowChainMail, Classes.Item.Type.DrowChainMail);
            map.Add(Type.DrowLongSword, Classes.Item.Type.DrowLongSword);
            map.Add(Type.Type_98, Classes.Item.Type.Spine);
            ...
            map.Add(Type.Type_102, Classes.Item.Type.Type_102);
            map.Add(Type.Type_103, Classes.Item.Type.Type_103);
            map.Add(Type.Type_104, Classes.Item.Type.Type_104);
            map.Add(Type.Type_105, Classes.Item.Type.Type_105);
            map.Add(Type.Type_106, Classes.Item.Type.Type_106);
            map.Add(Type.Type_107, Classes.Item.Type.Type_107);
            map.Add(Type.Type_108, Classes.Item.Type.Type_108);
            map.Add(Type.Type_109, Classes.Item.Type.Type_109);
            map.Add(Type.Type_110, Classes.Item.Type.Type_110);
            map.Add(Type.Type_128, Classes.Item.Type.Type_128);
