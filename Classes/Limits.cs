...
namespace Classes
{
    public static class Limits
    {
        public static int[,] RaceAgeBrackets = { //unk_1A434
            { 9999, 9999, 9999, 9999, 9999, 9999}, // monster, made-up
            {   34,   50,  150,  250,  350,  450}, // dwarf
            {   99,  175,  550,  875, 1200, 1600}, // elf
            {   49,   90,  300,  450,  600,  750}, // gnome
            {   23,   40,  100,  175,  250,  325}, // half elf
            {   21,   33,   68,  101,  144,  199}, // halfling
            {   11,   15,   30,   45,   60,   80}, // half orc
            {   13,   20,   40,   60,   90,  120}, // human
        };
