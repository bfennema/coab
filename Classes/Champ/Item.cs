namespace Classes.Champ
{
    public class Item
    {
        ...
        private static BiLookup<Names, Classes.Item.Names> InitNamesMap()
        {
            ...
            map.Add(Names.Cler, Classes.Item.Names.Cler);
            ...
            map.Add(Names.Belt, Classes.Item.Names.Belt);
            ...
            map.Add(Names.of_Prot, Classes.Item.Names.of_ProtDOT);
            ...
            map.Add(Names.Holy_Water, Classes.Item.Names.Holy_Water_vial);
            map.Add(Names.Ruby, Classes.Item.Names.Ruby);
            ...
            map.Add(Names.HornetAPOSs_Nest, Classes.Item.Names.Hornets_Nest);
            map.Add(Names.WEAPONHoopak, Classes.Item.Names.WEAPONHoopak);
            map.Add(Names.ARMORSolamnic_Plate, Classes.Item.Names.ARMORSolamnic_Plate);
            map.Add(Names.WEAPONDragonlance, Classes.Item.Names.WEAPONDragonlance);
            ...
            map.Add(Names.Proof_vs_Poison, Classes.Item.Names.Proof_vs_Poison);
            map.Add(Names.Dust, Classes.Item.Names.Dust);
            map.Add(Names.Disappearance, Classes.Item.Names.Disappearance);
            map.Add(Names.Disruption, Classes.Item.Names.Disruption);
            ...
            map.Add(Names.vs_Reptiles, Classes.Item.Names.vs_Reptiles);
            ...
            map.Add(Names.Opening, Classes.Item.Names.Opening);
            ...
            map.Add(Names.ONE_Spell, Classes.Item.Names.ONE_Spell);
            map.Add(Names.TWO_Spells, Classes.Item.Names.TWO_Spells);
            map.Add(Names.THREE_Spell, Classes.Item.Names.THREE_Spell);
            map.Add(Names.Paralyzation, Classes.Item.Names.Paralyzation);
            map.Add(Names.Invisibility, Classes.Item.Names.Invisibility);
            map.Add(Names.FootmanAPOSs, Classes.Item.Names.FootmanAPOSs);
            ...
            map.Add(Names.White, Classes.Item.Names.White);
            map.Add(Names.Red, Classes.Item.Names.Red);
        ...
        private static BiLookup<Type, Classes.Item.Type> InitTypeMap()
        {
            ...
            map.Add(Type.Helm, Classes.Item.Type.Helm);
            ...
            map.Add(Type.Mirror, Classes.Item.Type.Mirror);
            ...
            map.Add(Type.YellowCanary, Classes.Item.Type.YellowCanary);
            map.Add(Type.CloudGiantBoulder, Classes.Item.Type.CloudGiantBoulder);
            map.Add(Type.HillGiantBoulder, Classes.Item.Type.HillGiantBoulder);
            map.Add(Type.FireGiantBoulder, Classes.Item.Type.FireGiantBoulder);
            ...
            map.Add(Type.MaceB, Classes.Item.Type.MaceB);
            map.Add(Type.ElfinChain, Classes.Item.Type.ElvenChain);
            ...
            map.Add(Type.Hoopak, Classes.Item.Type.Hoopak);
            map.Add(Type.SolamnicPlate, Classes.Item.Type.SolamnicPlate);
            map.Add(Type.FootmansDragonlance, Classes.Item.Type.FootmansDragonlance);
            ...
            map.Add(Type.VorpalLongSword, Classes.Item.Type.VorpalLongSword);
            map.Add(Type.BlessedBolts, Classes.Item.Type.BlessedBolts);
            map.Add(Type.CloakOfProt, Classes.Item.Type.CloakOfProt);
            map.Add(Type.BeltOfProt, Classes.Item.Type.BeltOfProt);
        ...
        private enum Names
        {
            ...
            HornetAPOSs_Nest = 0x42,
            WEAPONHoopak = 0x43,
            ARMORSolamnic_Plate = 0x44,
            WEAPONDragonlance = 0x45,
            WEAPONFlail = 0x46,

            WEAPONHalberd = 0x47,
            Gauntlets = 0x48,
            Periapt = 0x49,
            Proof_vs_Poison = 0x4A,
            Dust = 0x4B,
        ...
        public enum Type
        {
            ...
            Boots = 45,
            Ring = 46,
            Potion = 47, // Diamond, Emerald, Saphire, Ruby, Potion of Healing, Potion of Speed, Potion of Extra Healing, Potion of Invisibility, Periapt Proof vs Posion, Necklace of Missiles
            Mirror = 48,
            Bracers = 50,
            WandA = 51, // Wand of Paralyzation, Wand of Lightning
            WandB = 52, // Wand of Magic Missile, Wand of Ice Storm, Wand of Fireballs
            PotionOfGiantStr = 53,
            YellowCanary = 54,
            CloudGiantBoulder = 55,
            HillGiantBoulder = 56,
            FireGiantBoulder = 57,
            CloakOfDisplacement = 58,
            RingOfProt = 59, // Ring of Protection
            MaceB = 60,
            ElfinChain = 61,
            DrowChainMail = 62,
            DrowLongSword = 63,
            ...
            Hoopak = 67,
            SolamnicPlate = 68,
            FootmansDragonlance = 69,
            Flail = 70,
            Halberd = 71,
            Gauntlets = 72, // Gauntlets of Ogre Power
            VorpalLongSword = 73,
            BlessedBolts = 74,
            CloakOfProt = 75,
            BeltOfProt = 77,
