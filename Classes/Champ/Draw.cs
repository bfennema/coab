    ...
    internal class Draw
    {
        ...
        internal static void Frame_Outer() /* draw8x8_01 */
        {
            ...
            for (int row_y = 0; row_y < 0x17; row_y++)
            {
                ...
                gbl.Put8x8Symbol(0, false, outer_frame_vertical[row_y] + 0x114, row_y, 0x27);
            }
        ...
        internal static void Frame_Dungeon() // draw8x8_03
        {
            ...
            for (int row_y = 0; row_y < 0x17; row_y++)
            {
                gbl.Put8x8Symbol(0, false, outer_frame_vertical_dungeon[row_y] + 0x114, row_y, 0);
                gbl.Put8x8Symbol(0, false, outer_frame_vertical_dungeon[row_y] + 0x114, row_y, 0x27);
            }
            ...
            {
                gbl.Put8x8Symbol(0, false, outer_frame_horizontal[colX] + 0x114, 0x10, colX);
            }

            for (int rowY = 0; rowY <= 0x10; rowY++)
            {
                gbl.Put8x8Symbol(0, false, frame_middle_vertical[rowY] + 0x114, rowY, 0x10);
            }
        ...
        internal static void Frame_Wilderness() // draw8x8_04
        {
            ...
            for (int col_x = 0; col_x <= 0x27; col_x++)
            {
                gbl.Put8x8Symbol(0, false, outer_frame_horizontal[col_x] + 0x114, 0x10, col_x);
            }
        ...
        internal static void Frame_Combat() // draw8x8_06
        {
            ...
            {
                gbl.Put8x8Symbol(0, false, combat_frame_left[row_y] + 0x114, row_y, 0);
                gbl.Put8x8Symbol(0, false, combat_frame_middle[row_y] + 0x114, row_y, 0x16);
                gbl.Put8x8Symbol(0, false, combat_frame_right[row_y] + 0x114, row_y, 0x27);
            }

            // Bottom Bar
            for (int col_x = 0; col_x <= 0x27; col_x++)
            {
                gbl.Put8x8Symbol(0, false, outer_frame_horizontal[col_x] + 0x114, 0x16, col_x);
            }
