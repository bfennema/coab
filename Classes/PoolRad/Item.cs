...
namespace Classes.PoolRad
{
    public class Item
    {
        ...
        private static BiLookup<Names, Classes.Item.Names> InitNamesMap()
        {
            ...
            map.Add(Names.WEAPONFine, Classes.Item.Names.WEAPONFine);
            ...
            map.Add(Names.Apparatus, Classes.Item.Names.Apparatus);
            map.Add(Names.Bag, Classes.Item.Names.Bag);
            map.Add(Names.Beaker, Classes.Item.Names.Beaker);
            map.Add(Names.Boat, Classes.Item.Names.Boat);
            map.Add(Names.Book, Classes.Item.Names.Book);
            map.Add(Names.Boots, Classes.Item.Names.Boots);
            map.Add(Names.Bowl, Classes.Item.Names.Bowl);
            map.Add(Names.Bracers, Classes.Item.Names.Bracers);
            map.Add(Names.Brazier, Classes.Item.Names.Brazier);
            map.Add(Names.Brooch, Classes.Item.Names.Brooch);
            map.Add(Names.Broom, Classes.Item.Names.Broom);
            map.Add(Names.Purse, Classes.Item.Names.Purse);
            map.Add(Names.Candle, Classes.Item.Names.Candle);
            map.Add(Names.Carpet, Classes.Item.Names.Carpet);
            map.Add(Names.Censer, Classes.Item.Names.Censer);
            ...
            map.Add(Names.Fortress, Classes.Item.Names.Fortress);
            map.Add(Names.Decanter, Classes.Item.Names.Decanter);
            map.Add(Names.Deck, Classes.Item.Names.Deck);
            map.Add(Names.Drums, Classes.Item.Names.Drums);
            map.Add(Names.Dust, Classes.Item.Names.Dust);
            map.Add(Names.Eyes, Classes.Item.Names.Eyes);
            map.Add(Names.Figurine, Classes.Item.Names.Figurine);
            ...
            map.Add(Names.Horseshoes, Classes.Item.Names.Horseshoes);
            map.Add(Names.Incense, Classes.Item.Names.Incense);
            map.Add(Names.Stone, Classes.Item.Names.Stone);
            map.Add(Names.Instrument, Classes.Item.Names.Instrument);
            ...
            map.Add(Names.Libram, Classes.Item.Names.Libram);
            map.Add(Names.Lyre, Classes.Item.Names.Lyre);
            map.Add(Names.Manual, Classes.Item.Names.Manual);
            map.Add(Names.Mattock, Classes.Item.Names.Mattock);
            map.Add(Names.Maul, Classes.Item.Names.Maul);
            map.Add(Names.Medallion, Classes.Item.Names.Medallion);
            map.Add(Names.Mirror, Classes.Item.Names.Mirror);
            map.Add(Names.Necklace, Classes.Item.Names.Necklace);
            map.Add(Names.Net, Classes.Item.Names.Net);
            map.Add(Names.Pigment, Classes.Item.Names.Pigment);
            map.Add(Names.Pearl, Classes.Item.Names.Pearl);
            map.Add(Names.Periapt, Classes.Item.Names.Periapt);
            map.Add(Names.Phylactery, Classes.Item.Names.Phylactery);
            map.Add(Names.Pipes, Classes.Item.Names.Pipes);
            map.Add(Names.Hole, Classes.Item.Names.Hole);
            map.Add(Names.Token, Classes.Item.Names.Token);
            map.Add(Names.Robe, Classes.Item.Names.Robe);
            map.Add(Names.Rope, Classes.Item.Names.Rope);
            map.Add(Names.Rug, Classes.Item.Names.Rug);
            map.Add(Names.Saw, Classes.Item.Names.Saw);
            ...
            map.Add(Names.Small_Raft, Classes.Item.Names.Small_Raft);
            map.Add(Names.Cart, Classes.Item.Names.Cart);
            ...
            map.Add(Names.Bodily_Health, Classes.Item.Names.Bodily_Health);
            ...
            map.Add(Names.Clerical_Scroll, Classes.Item.Names.Clrc_Scroll);
            map.Add(Names.Magic_User_Scroll, Classes.Item.Names.MU_Scroll);
            ...
            map.Add(Names.Protection_Scroll, Classes.Item.Names.ProtDOT_Scroll);
            ...
            map.Add(Names.of_Protection, Classes.Item.Names.of_ProtDOT);
        ...
        private static BiLookup<Type, Classes.Item.Type> InitTypeMap()
        {
            ...
            map.Add(Type.Bardiche, Classes.Item.Type.Bardiche);
            map.Add(Type.BecDeCorbin, Classes.Item.Type.BecDeCorbin);
            map.Add(Type.BillGuisarme, Classes.Item.Type.BillGuisarme);
            map.Add(Type.BoStick, Classes.Item.Type.BoStick);
            ...
            map.Add(Type.Fauchard, Classes.Item.Type.Fauchard);
            map.Add(Type.FauchardFork, Classes.Item.Type.FauchardFork);
            map.Add(Type.Flail, Classes.Item.Type.Flail);
            map.Add(Type.MilitaryFork, Classes.Item.Type.MilitaryFork);
            map.Add(Type.Glaive, Classes.Item.Type.Glaive);
            map.Add(Type.GlaiveGuisarme, Classes.Item.Type.GlaiveGuisarme);
            map.Add(Type.Guisarme, Classes.Item.Type.Guisarme);
            map.Add(Type.GuisarmeVoulge, Classes.Item.Type.GuisarmeVoulge);
            map.Add(Type.Halberd, Classes.Item.Type.Halberd);
            map.Add(Type.LucernHammer, Classes.Item.Type.LucernHammer);
            map.Add(Type.Hammer, Classes.Item.Type.Hammer);
            map.Add(Type.Javelin, Classes.Item.Type.Javelin);
            map.Add(Type.JoStick, Classes.Item.Type.JoStick);
            map.Add(Type.Mace, Classes.Item.Type.Mace);
            map.Add(Type.MorningStar, Classes.Item.Type.MorningStar);
            map.Add(Type.Partisan, Classes.Item.Type.Partisan);
            ...
            map.Add(Type.Ranseur, Classes.Item.Type.Ranseur);
            map.Add(Type.Scimitar, Classes.Item.Type.Scimitar);
            map.Add(Type.Spear, Classes.Item.Type.Spear);
            map.Add(Type.Spetum, Classes.Item.Type.Spetum);
            ...
            map.Add(Type.Voulge, Classes.Item.Type.Voulge);
            ...
            map.Add(Type.FineBow, Classes.Item.Type.FineBow);
            ...
            map.Add(Type.PaddedArmor, Classes.Item.Type.PaddedArmor);
            map.Add(Type.StuddedLeather, Classes.Item.Type.StuddedLeather);
            ...
            map.Add(Type.SplintMail, Classes.Item.Type.SplintMail);
            ...
            map.Add(Type.ClrcScroll, Classes.Item.Type.ClrcScroll);
            map.Add(Type.Gauntlets, Classes.Item.Type.Gauntlets);
            map.Add(Type.CloakOfProt, Classes.Item.Type.CloakOfProt);
            map.Add(Type.Ring, Classes.Item.Type.Ring);
            map.Add(Type.GemsJewelry, Classes.Item.Type.GemsJewelry);
            map.Add(Type.Potion, Classes.Item.Type.Potion);
            map.Add(Type.Commodities, Classes.Item.Type.Commodities);
            map.Add(Type.Arrow, Classes.Item.Type.Arrow);
            map.Add(Type.HolySymbol, Classes.Item.Type.HolySymbol);
            map.Add(Type.Key, Classes.Item.Type.Key);
            map.Add(Type.CursedNecklace, Classes.Item.Type.CursedNecklace);
            ...
            map.Add(Type.EfreetiBottle, Classes.Item.Type.EfreetiBottle);
            map.Add(Type.PotionOfGiantStr, Classes.Item.Type.PotionOfGiantStr);
            map.Add(Type.HolyWater, Classes.Item.Type.HolyWater);
            map.Add(Type.FlaskOfOil, Classes.Item.Type.FlaskOfOil);
            map.Add(Type.HillGiantBoulder, Classes.Item.Type.HillGiantBoulder);
            map.Add(Type.RingOfFeatherFall, Classes.Item.Type.RingOfFeatherFall);
            map.Add(Type.Pass, Classes.Item.Type.Pass);
        ...
        public Item(Classes.Item item)
        {
            ...
            if (item.type == Classes.Item.Type.Gauntlets && item.affect_2 == 0 && item.affect_3 == 131) // gauntlets of ogre power
            {
                affect_2 = (byte)Affects.strength;
                affect_3 = 131;
            }
            else if (item.type == Classes.Item.Type.Cloak && item.Affect_2 == Affects.displace && item.Affect_3 == Affects.item_affect) // cloak of displacement
            {
                affect_3 = 133;
            }
            else if (item.type == Classes.Item.Type.CloakOfProt && item.Affect_2 == Affects.camouflage && item.Affect_3 == Affects.item_affect) // cloak of elvenkind
            {
                affect_3 = 134;
            }
            else if (item.type == Classes.Item.Type.Ring && item.Affect_2 == Affects.item_invisibility && item.Affect_3 == Affects.item_affect) // ring of invisibility
            {
                affect_3 = 139;
            }
            else if (item.type == Classes.Item.Type.Ring && item.Affect_2 == Affects.item_fire_resist && item.Affect_3 == Affects.item_affect) // ring of fire resistance
            {
                affect_3 = 129;
            }
            else if (item.type == Classes.Item.Type.WandB && item.affect_2 == 65) // wand of magic missiles
            {
                affect_2 = 88;
            }
            else if (item.type != Classes.Item.Type.ClrcScroll && item.type != Classes.Item.Type.MUScroll && item.Affect_2 == Affects.weap_flame_tongue && item.Affect_3 == Affects.item_affect) // flame tongue
            {
                affect_2 = 22;
                affect_3 = 0;
            }
            else if (item.type != Classes.Item.Type.ClrcScroll && item.type != Classes.Item.Type.MUScroll && item.Affect_2 == Affects.weap_undead_slayer && item.Affect_3 == Affects.item_affect) // undead slayer
            {
                affect_2 = (byte)Affect.Affects.weap_undead_slayer;
                affect_3 = 136;
            }
        }
        ...
        public Classes.Item Load()
        {
            ...
            if (item.type == Classes.Item.Type.Gauntlets && item.Affect_2 == Classes.Affects.strength && item.affect_3 == 131) // gauntlets of ogre power
            {
                item.affect_2 = 0;
            }
            else if (item.type == Classes.Item.Type.Cloak && item.Affect_2 == Affects.displace && item.affect_3 == 133) // cloak of displacement
            {
                item.Affect_3 = Classes.Affects.item_affect;
            }
            else if (item.type == Classes.Item.Type.CloakOfProt && item.Affect_2 == Affects.camouflage && item.affect_3 == 134) // cloak of elvenkind
            {
                item.Affect_3 = Classes.Affects.item_affect;
            }
            else if (item.type == Classes.Item.Type.Ring && item.Affect_2 == Affects.item_invisibility && item.affect_3 == 139) // ring of invisibility
            {
                item.Affect_3 = Classes.Affects.item_affect;
            }
            else if (item.type == Classes.Item.Type.Ring && item.Affect_2 == Affects.item_fire_resist && item.affect_3 == 129) // ring of fire resistance
            {
                item.Affect_3 = Classes.Affects.item_affect;
            }
            else if (item.type == Classes.Item.Type.WandB && item.affect_2 == 88) // wand of magic missiles
            {
                item.affect_2 = 65;
            }
            else if (item.type != Classes.Item.Type.ClrcScroll && item.type != Classes.Item.Type.MUScroll && item.affect_1 == 0 && item.affect_2 == 22 && item.affect_3 == 0) // flame tongue
            {
                item.Affect_2 = Classes.Affects.weap_flame_tongue;
                item.Affect_3 = Classes.Affects.item_affect;
            }
            else if (item.affect_2 == (byte)Affect.Affects.weap_undead_slayer && item.affect_3 == 136) // weapon vs undead
            {
                item.Affect_2 = Classes.Affects.weap_undead_slayer;
                item.Affect_3 = Classes.Affects.item_affect;
            }
        ...
        public byte[] Save(Classes.Player player, List<Affect> affects)
        {
