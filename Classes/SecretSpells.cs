namespace Classes
{
    public class SecretSpells
    {
        enum Spells
        {
            ...
            charm_person_mammal = 0x60,
            potion_of_invisibility = 0x61,
            cure_light_wounds_DR = 0x62,
            ...
            destruction = 0x68,
            resurrection = 0x69,
            cure_disease_DR = 0x6a,
            hold_animal = 0x6b,
            neutralize_poison_DR = 0x6c,
            protection_from_fire  = 0x6d,
            death_spell = 0x6e,
            disintegrate = 0x6f,
            globe_of_invuln = 0x70,
            stone_flesh = 0x71,
            flesh_stone = 0x72,
            delayed_blast_fireball = 0x73,
            mass_invisibility = 0x74,
            power_word_stun = 0x75,
            //spell_88 = 0x88,
        }
        ...
        static void InitMapping()
        {
            ...
            mapping.Add(Spells.charm_person_mammal, Classes.Spells.charm_person_mammal);
            mapping.Add(Spells.cure_light_wounds_DR, Classes.Spells.cure_light_wounds_DR);
            mapping.Add(Spells.barkskin, Classes.Spells.barkskin);
            mapping.Add(Spells.protection_from_fire, Classes.Spells.protection_from_fire);
        }
