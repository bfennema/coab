...
namespace Classes
{
    ...
    public enum Spells
    {
        ...
        cure_disease_CL = 0x27,
        cause_disease_CL = 0x28,
        ...
        cause_disease_DR = 0x6b,
        hold_animal = 0x6c,
        neutralize_poison_DR = 0x6d,
        protection_from_fire = 0x6e,
        cure_serious_wounds_DR = 0x6f,
        cause_serious_wounds_DR = 0x70,
        dispel_magic_DR = 0x71,
        hold_plant = 0x72,
        protection_from_lightning = 0x73,
        sticks_to_snakes_DR = 0x74,
        //spell_88 = 0x88,
    }
